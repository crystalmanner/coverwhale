<template>
  <div class="w-10/12 xs:w-9/12 sm:w-8/12 lg:w-7/12 mx-auto pt-12 pb-20 md:py-28">
    ...
    <div class="text-sm flex flex-col gap-12 text-left">
      <p>
        This talks about CoverWhale for agents, and how the process is going to
        make their sales cycles shorter. consectetur adipiscing elit, sed do
